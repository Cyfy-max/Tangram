...
public class LoadGame7 : MonoBehaviour
{
    ...
    void loadPosition()
    {
        SSTools.ShowMessage("Level 7 Good Luck!", SSTools.Position.bottom, SSTools.Time.threeSecond);
        ...
        double[] x0s = new[] { 1.5, 0.15, 0 };
        double[] x1s = new[] { -2.65, 0.13, -180 };
        double[] x2s = new[] { 2.53, 0.15, 90 };
        double[] x3s = new[] { 0.67, -0.2, 0 };
        double[] x4s = new[] { 0.45, 0.6, -90 };
        double[] x5s = new[] { -2.65, 0, 0 };
        double[] x6s = new[] { -1.1, 0.64, 90 };
