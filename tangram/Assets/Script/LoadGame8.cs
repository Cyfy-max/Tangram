...
public class LoadGame8 : MonoBehaviour
{
    ...
    void loadPosition()
    {
        SSTools.ShowMessage("Level 8 Good Luck!", SSTools.Position.bottom, SSTools.Time.threeSecond);
        ...
        double[] x0s = new[] { -0.8, 1.5, 0 };
        double[] x1s = new[] { 1.72, 1.52, 180 };
        double[] x2s = new[] { 0.2, 1.5, 0 };
        double[] x3s = new[] { -1.32, 1.63, -45 };
        double[] x4s = new[] { 0.93, 1.56, -225 };
        double[] x5s = new[] { -1.3, 2.64, 270 };
        double[] x6s = new[] { -1.3, 0.61, 360 };
