...
public class LoadGame3 : MonoBehaviour
{
    ...
    void loadPosition()
    {
        SSTools.ShowMessage("Level 3 Good Luck!", SSTools.Position.bottom, SSTools.Time.threeSecond);
        ...
        double[] x0s = new[] { -1.84, 1.89, 0 };
        double[] x1s = new[] { 2.67, 1.95, 405 };
        double[] x2s = new[] { 2.68, 0.96, 405 };
        double[] x3s = new[] { -2.43, 1.84, -45 };
        double[] x4s = new[] { -0.19, 1.73, 135 };
        double[] x5s = new[] { 0.92, 1.38, 90 };
        double[] x6s = new[] { -0.73, 1.26, 45 };
