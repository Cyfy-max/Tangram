...
public class LoadGame9 : MonoBehaviour
{
    ...
    void loadPosition()
    {
        SSTools.ShowMessage("Level 9 Good Luck!", SSTools.Position.bottom, SSTools.Time.threeSecond);
        ...
        double[] x0s = new[] { -1.03, 1.98, 13 };
        double[] x1s = new[] { 1.73, 0.58, -180 };
        double[] x2s = new[] { 1.86, 2.11, -135 };
        double[] x3s = new[] { -0.36, 1.45, -223 };
        double[] x4s = new[] { 0.62, 2.04, 93 };
        double[] x5s = new[] { -0.3, 0.4, 24 };
        double[] x6s = new[] { -1.53, 2.45, -121 };
