...
public class LoadGame : MonoBehaviour {
    ...
    void loadPosition()
    {
        SSTools.ShowMessage("Level 1 Good Luck!", SSTools.Position.bottom, SSTools.Time.threeSecond);
        ...
        double[] x0s = new[] { 0, 2.38, 0 };
        double[] x1s = new[] { -0.01, 0.48, 270 };
        double[] x2s = new[] { -0.05, 3.48, 180 };
        double[] x3s = new[] { -0.66, 2.96, -135 };
        double[] x4s = new[] { -1.51, -0.56, 0 };
        double[] x5s = new[] { -0.43, -0.12, 90 };
        double[] x6s = new[] { -0.54, 1.45, 315 };
