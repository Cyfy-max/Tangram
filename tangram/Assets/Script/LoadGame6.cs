...
public class LoadGame6 : MonoBehaviour
{
    ...
    void loadPosition()
    {
        SSTools.ShowMessage("Level 6 Good Luck!", SSTools.Position.bottom, SSTools.Time.threeSecond);
        ...
        double[] x0s = new[] { -2.2, 1.7, 65 };
        double[] x1s = new[] { 2.7, 1.9, 45 };
        double[] x2s = new[] { 2, -0.6, 0 };
        double[] x3s = new[] { 1.6, 2, 225 };
        double[] x4s = new[] { -0.6, -0.13, -70 };
        double[] x5s = new[] { -0.42, 1.67, 0 };
        double[] x6s = new[] { 0.43, 0.93, -180 };
