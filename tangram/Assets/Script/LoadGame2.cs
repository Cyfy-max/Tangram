...
public class LoadGame2 : MonoBehaviour
{
    ...
    void loadPosition()
    {
        SSTools.ShowMessage("Level 2 Good Luck!", SSTools.Position.bottom, SSTools.Time.threeSecond);
        ...
        double[] x0s = new[] { -1.27, 2.19, 0 };
        double[] x1s = new[] { -1.87, 2.2, 315 };
        double[] x2s = new[] { 1.42, 1.46, 315 };
        double[] x3s = new[] { 1.26, 0.46, -270 };
        double[] x4s = new[] { -1.3, -0.33, -90 };
        double[] x5s = new[] { 0.29, 1.75, 0 };
        double[] x6s = new[] { 0.3, -0.35, -90 };
