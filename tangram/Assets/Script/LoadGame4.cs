...
public class LoadGame4 : MonoBehaviour
{
    ...
    void loadPosition()
    {
        SSTools.ShowMessage("Level 4 Good Luck!", SSTools.Position.bottom, SSTools.Time.threeSecond);
        ...
        double[] x0s = new[] { -1.16, 0, 0 };
        double[] x1s = new[] { 1.44, 0.71, 315 };
        double[] x2s = new[] { -1.66, 0.01, 315 };
        double[] x3s = new[] { -2.2, 2.75, 180 };
        double[] x4s = new[] { -0.2, 3.15, -405 };
        double[] x5s = new[] { -0.34, 2.56, 0 };
        double[] x6s = new[] { 0.38, 0.4, -90 };
