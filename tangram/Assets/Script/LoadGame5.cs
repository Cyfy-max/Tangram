...
public class LoadGame5 : MonoBehaviour
{
    ...
    void loadPosition()
    {
        SSTools.ShowMessage("Level 5 Good Luck!", SSTools.Position.bottom, SSTools.Time.threeSecond);
        ...
        double[] x0s = new[] { -1, 0.23, 45 };
        double[] x1s = new[] { -1.75, 1, 45 };
        double[] x2s = new[] { -1.75, -0.52, 225 };
        double[] x3s = new[] { 0.07, 1, -45 };
        double[] x4s = new[] { 2.25, 3.2, 50 };
        double[] x5s = new[] { 1.2, 1, 0 };
        double[] x6s = new[] { 1.35, 1, -180 };
